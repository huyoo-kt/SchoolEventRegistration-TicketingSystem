public class Receipt {
    ...
    void printReceipt(){
        ...
        System.out.println("Original Fee       : " + String.format("%.2f",registration.getDiscountAmount()));
        System.out.println("Original Fee       : " + String.format("%.2f",registration.getFinalFee()));
